...
private:
    static constexpr double TAXA_MUTACAO = 0.3;
    static constexpr double TAXA_CROSSOVER = 0.7;
    static constexpr int NUM_ELITISMO = 20;
    static constexpr double INTENSIDADE_MUTACAO = 0.3;
